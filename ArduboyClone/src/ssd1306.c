...
void drawBitMap(uint8_t x, uint8_t y, const uint8_t *map, uint8_t linhas, uint8_t colunas)
{

  uint8_t w = 0;       // determina o contador das colunas a serem lidas
  uint8_t k = 0;       // determina o contador das linhas a serem lidas
  uint8_t ajuste = 0;  // utilizado para atualizar o grupo de pixeis a ser ligado
